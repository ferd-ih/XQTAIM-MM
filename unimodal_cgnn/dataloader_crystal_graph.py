...
class CrystalGraphDataset(Dataset):
    def __init__(self, graph_files, normalizer=None):
        """
        Dataset for loading pre-processed crystal graphs.
        
        Args:
            graph_files (list): List of paths to pre-processed graph files (.pt)
            normalizer (dict, optional): Pre-computed normalizers
        """
        super().__init__()
